...
SET TOOLS=.\tools
SET OUTPUTNAME=ReactDesktopApps-console.exe
SET ILMERGE=%TOOLS%\ILMerge.exe
SET RELEASE=..\..\ReactDesktopApps.AppConsole\bin\Release
SET INPUT=%RELEASE%\ReactDesktopApps.AppConsole.exe
SET INPUT=%INPUT% %RELEASE%\ReactDesktopApps.Resources.dll
SET INPUT=%INPUT% %RELEASE%\ReactDesktopApps.ServiceInterface.dll
SET INPUT=%INPUT% %RELEASE%\ReactDesktopApps.ServiceModel.dll
